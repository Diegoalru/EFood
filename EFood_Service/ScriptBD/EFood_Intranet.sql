...
(
    ...
    ,CONSTRAINT UQ_DESCUENTO_DESCRIPCION UNIQUE (DESCRIPCION)
...
INSERT
INTO
    TIPO_CONSECUTIVOS (TIPO)
VALUES   (N'Tipos de Precio')
...
INTO
    TIPO_ESTADO (TIPO)
VALUES
(N'En curso'), (N'Procesada'), (N'Cancelada');
GO
...
INSERT INTO TIPO_TARJETA (CODIGO , TIPO) VALUES (NULL, 'MasterCard');
...
BEGIN
    ...
    IF EXISTS(SELECT USUARIO FROM dbo.V_ADMINISTRADORES_ACTIVOS WHERE USUARIO LIKE @USUARIO)
        BEGIN
            -- EXISTE EL USUARIO
            IF EXISTS(SELECT CODE FROM ADMINISTRADOR WHERE USUARIO LIKE @USUARIO AND CLAVE = @CLAVE)
                BEGIN
...
BEGIN
    ...
    IF EXISTS(SELECT * FROM ADMINISTRADOR WHERE USUARIO LIKE @USUARIO AND CLAVE LIKE @CLAVE)
        BEGIN
...
BEGIN
    ...
    SELECT @PREFIJO = PREFIJO, @NUMERO = NUM_CONSECUTIVO FROM CONSECUTIVO WHERE TIPO = @TIPO;
...
BEGIN
    DECLARE @RESULT BIT = 0;
    IF EXISTS(SELECT CODE FROM ADMINISTRADOR WHERE USUARIO LIKE @USUARIO)
        BEGIN
            SET @RESULT = 1;
        END
    RETURN @RESULT;
...
BEGIN
    ...
    IF EXISTS(SELECT * FROM DESCUENTO WHERE CODIGO LIKE @CODIGO)
        BEGIN
            IF EXISTS(SELECT * FROM DESCUENTO WHERE CODIGO LIKE @CODIGO AND ESTADO = 1 AND DISPONIBLES > 0)
                BEGIN
                    SET @RESULT = 1;
                END
            ELSE
...
BEGIN
    DECLARE @RESULT BIT = 0;
    IF EXISTS(SELECT * FROM PROCESADOR_PAGO WHERE PROCESADOR LIKE @PROCESADOR)
        BEGIN
            SET @RESULT = 1;
        END
    RETURN @RESULT;
...
BEGIN
    DECLARE @RESULT BIT = 0;
    IF EXISTS(SELECT * FROM PRODUCTO WHERE DESCRIPCION LIKE @DESCRIPCION)
        BEGIN
            SET @RESULT = 1;
        END
    RETURN @RESULT;
...
BEGIN
    DECLARE @RESULT BIT = 0;
    IF EXISTS(SELECT TIPO FROM TIPO_LINEA WHERE TIPO LIKE @TIPO)
        BEGIN
            SET @RESULT = 1;
        END
    RETURN @RESULT;
...
BEGIN
    DECLARE @RESULT BIT = 0;
    IF EXISTS(SELECT TIPO FROM TIPO_PRECIO WHERE TIPO LIKE @TIPO)
        BEGIN
            SET @RESULT = 1;
        END
    RETURN @RESULT;
...
BEGIN
    DECLARE @RESULT BIT = 0;
    IF EXISTS(SELECT TIPO FROM TIPO_TARJETA WHERE TIPO LIKE @TIPO)
        BEGIN
            SET @RESULT = 1;
        END
    RETURN @RESULT;
...
BEGIN
    ...
    (CUENTA)
    VALUES
        ((SELECT CODE FROM ADMINISTRADOR WHERE USUARIO LIKE @USUARIO));
...
AS
BEGIN
    INSERT INTO BITACORA (CODIGO, MENSAJE, USUARIO) VALUES (@CODIGO, @MENSAJE, @USUARIO);
END
GO
...
BEGIN
    BEGIN
        INSERT INTO DESCUENTO (CODIGO, DESCRIPCION, DISPONIBLES, DESCUENTO)
        VALUES (@CODIGO, @DESCRIPCION, @DISPONIBLES, @DESCUENTO);
    end
end
GO
...
AS
BEGIN
    INSERT INTO ERROR (ERROR, MENSAJE) VALUES (@CODIGO, CONCAT('METODO: ', @METODO, ' , MENSAJE: ', @MENSAJE));
END
GO
...
AS
BEGIN
    INSERT INTO PRECIO (TIPO, PRODUCTO, MONTO) VALUES (@TIPO, @PRODUCTO, @MONTO);
end
GO
...
AS
BEGIN
    IF EXISTS(SELECT * FROM CONSECUTIVO WHERE TIPO = 3)
        BEGIN
            ...
            -- INSERT PRODUCTO
            INSERT
            INTO PROCESADOR_PAGO (CODIGO, PROCESADOR, TIPOPAGO, ESTADO)
            VALUES (@CODIGO, @PROCESADOR, @TIPOPAGO, @ESTADO);
    ...
    ELSE
        BEGIN
            INSERT
            INTO PROCESADOR_PAGO (CODIGO, PROCESADOR, TIPOPAGO, ESTADO)
            VALUES (NULL, @PROCESADOR, @TIPOPAGO, @ESTADO);
        end
end
GO
...
AS
BEGIN
    IF EXISTS(SELECT * FROM CONSECUTIVO WHERE TIPO = 5)
        BEGIN
            DECLARE @CODIGO NVARCHAR(11);
            ...
            -- INSERT PRODUCTO
            INSERT
            INTO PRODUCTO (CODIGO, DESCRIPCION, LINEA, CONTENIDO)
            VALUES (@CODIGO, @DESCRIPCION, @LINEA, @CONTENIDO);
    ...
    ELSE
        BEGIN
            INSERT
            INTO PRODUCTO (CODIGO, DESCRIPCION, LINEA, CONTENIDO)
            VALUES (NULL, @DESCRIPCION, @LINEA, @CONTENIDO);
        end
end
GO
...
AS
BEGIN
    INSERT INTO TARJETA_PROCESADOR (TIPO, PROCESADOR)
    VALUES (@TIPO, @PROCESADOR);
end
GO
...
AS
BEGIN
    IF EXISTS(SELECT * FROM CONSECUTIVO WHERE TIPO = 4)
        BEGIN
            DECLARE @CODIGO NVARCHAR(11);
...
AS
BEGIN
    IF EXISTS(SELECT * FROM CONSECUTIVO WHERE TIPO = 1)
        BEGIN
            DECLARE @CODIGO NVARCHAR(11);
...
AS
BEGIN
    IF EXISTS(SELECT * FROM CONSECUTIVO WHERE TIPO = 2)
        BEGIN
            DECLARE @CODIGO NVARCHAR(11);
...
CREATE OR ALTER PROCEDURE dbo.MODIFICA_CANTIDAD_DISPONIBLES_DESCUENTO
(
    @CODE INTEGER
,@DISPONIBLES INTEGER
)
AS
BEGIN
    UPDATE DESCUENTO SET DISPONIBLES = @DISPONIBLES WHERE CODE = @CODE;
end
GO
...
BEGIN
    DECLARE @RESULT BIT;
    SELECT @RESULT = ACTIVO FROM ADMINISTRADOR WHERE USUARIO LIKE @USUARIO;
    RETURN @RESULT;
end
GO
...
AS
SELECT CODE, USUARIO FROM ADMINISTRADOR;
GO

CREATE OR ALTER VIEW [dbo].[V_ADMINISTRADORES_ACTIVOS]
AS
SELECT CODE, USUARIO FROM ADMINISTRADOR WHERE ACTIVO = 1;
GO

CREATE OR ALTER VIEW dbo.V_BITACORA
AS
SELECT CODE, FECHA, CODIGO, MENSAJE, USUARIO FROM BITACORA;
GO
...
AS
SELECT CODE, TIPO FROM TIPO_CONSECUTIVOS;
GO

CREATE OR ALTER VIEW dbo.V_DESCUENTOS
AS
SELECT CODE, DESCRIPCION, DESCUENTO, DISPONIBLES
FROM DESCUENTO
WHERE ESTADO = 1;
GO
...
AS
SELECT CODE, PREGUNTA FROM PREGUNTA;
GO
...
AS
SELECT CODE, TIPO FROM TIPO_ESTADO;
GO
...
AS
SELECT CODE, TIPO FROM TIPO_PAGO;
GO
...
CREATE OR ALTER FUNCTION dbo.V_TIPO_TARJETAS_USADAS_PROCESADOR
(
    @PROCESADOR INTEGER
)
    RETURNS TABLE
        ...
        FROM
            TIPO_TARJETA AS TT
                INNER JOIN TARJETA_PROCESADOR TP
                           ON TT.CODE = TP.TIPO
        WHERE
                TP.PROCESADOR = @PROCESADOR;
GO
...
BEGIN
    DECLARE @RESULT BIT = 0;
    IF EXISTS(SELECT * FROM PEDIDO WHERE TRANSACCION = @TRANSACCION)
        BEGIN
            SET @RESULT = 1;
        END
    RETURN @RESULT;
...
(
    @TRANSACCION NVARCHAR(16)
,@DESCUENTO NVARCHAR(6)
,@PROCESADOR INTEGER
,@TIPO_TARJETA INTEGER
)
AS
BEGIN
    INSERT INTO PEDIDO (TRANSACCION, PROCESADOR, TIPO_TARJETA, DESCUENTO)
    VALUES (@TRANSACCION, @PROCESADOR, @TIPO_TARJETA, (SELECT CODE FROM DESCUENTO WHERE CODIGO = @DESCUENTO));
end
GO
...
AS
BEGIN
    INSERT INTO CARRITO (PEDIDO, PRECIO, CANTIDAD) VALUES ((SELECT CODE FROM PEDIDO WHERE TRANSACCION = @TRANSACCION), @PRECIO, @CANTIDAD);
end
GO

CREATE OR ALTER VIEW dbo.V_TIPO_LINEA_CLIENTE
AS
SELECT
    CODE, TIPO
FROM
...
CREATE OR ALTER FUNCTION dbo.V_PRODUCTOS_POR_TIPOLINEA_CLIENTE
(
    @TIPOLINEA INTEGER
)
    RETURNS TABLE
...
CREATE OR ALTER FUNCTION dbo.V_PRECIOS_PRODUCTO_CLIENTE
(
    @PRODUCTO INTEGER
)
    RETURNS TABLE
        ...
        FROM
            PRECIO AS PRC
                INNER JOIN TIPO_PRECIO AS TP
                           ON(PRC.TIPO = TP.CODE)
        WHERE
                PRC.PRODUCTO = @PRODUCTO;
GO

CREATE OR ALTER VIEW dbo.V_TIPO_PRECIO_CLIENTE
AS
SELECT
    CODE
     ,TIPO
...
CREATE OR ALTER VIEW dbo.V_TIPO_TARJETAS_CLIENTE
AS
SELECT
    CODE
     ,TIPO
...
CREATE OR ALTER VIEW dbo.V_TIPO_PAGO_CLIENTE
AS
SELECT
    CODE
     ,TIPO
